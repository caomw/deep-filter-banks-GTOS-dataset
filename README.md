...
This repository contains the code from [Deep-Reflectance-Code](https://github.com/zhanghang1989/Deep-Reflectance-Code.git), and [deep filter banks](https://github.com/mcimpoi/deep-fbanks.git). this algorithm is adapted to GTOS dataset.
